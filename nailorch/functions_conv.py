...
from nailorch.core import Function, as_variable
from nailorch.utils import pair, get_conv_outsize, get_deconv_outsize
from nailorch.functions import linear, broadcast_to
...
def im2col(x, kernel_size, stride=1, pad=0, to_matrix=True):
    ...
    Args:
        x (`nailorch.Variable` or `ndarray`): Input variable of shape
            `(N, C, H, W)`
    ...
    Returns:
        `nailorch.Variable`: Output variable. If the `to_matrix` is False, the
